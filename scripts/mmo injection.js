(()=>{
    ...
    setInterval(()=>{setlocal("Game","clock",0)})
    ...
    window.getplayers = function() {
        let c = vm.runtime.targets[4].sprite.clones;
        let plrs = [];
        for (let i in c) {plrs.push(c[i].variables["%?ot.iQuUk5;BfW32u|W"].value)};
        return plrs;
    };
})()